package ru.mirea.ryazhevilya.timeservice;
...
import ru.mirea.ryazhevilya.timeservice.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    private class GetTimeTask extends AsyncTask<Void, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            binding.textViewDate.setText(String.format("Today is %d of %s, %d", date.getDayOfMonth(), date.getMonth().getDisplayName(TextStyle.SHORT, Locale.ENGLISH), date.getYear()));
            binding.textViewTime.setText(String.format("UTC time is %s", time.toString()));
        }
    }
}